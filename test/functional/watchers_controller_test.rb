...
class WatchersControllerTest < ActionController::TestCase
  ...
  context "POST :new" do
    should "add groups" do
      @group = Group.create!(:lastname => "test").reload
  ...
  def test_new_multiple_users_watching_board
    ...
    @board = Board.create!(:project => @project, :name => "test", :description => "test")
  ...
  def test_new_multiple_users_watching_message
    ...
    @project = Project.find(1)
    @board = Board.create!(:project => @project, :name => "test", :description => "test")
    @message = Message.create!(:board => @board, :subject => "test", :content => "test")

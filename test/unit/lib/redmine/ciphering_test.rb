...
class Redmine::CipheringTest < ActiveSupport::TestCase
  ...
  def test_password_should_be_encrypted
    Redmine::Configuration.with 'database_cipher_key' => 'secret' do
      r = Repository::Subversion.create!(:password => 'foo', :url => 'file:///tmp')
  ...
  def test_unciphered_password_should_be_readable
    Redmine::Configuration.with 'database_cipher_key' => nil do
      r = Repository::Subversion.create!(:password => 'clear', :url => 'file:///tmp')
    end
  ...
  def test_encrypt_all
    ...
    Redmine::Configuration.with 'database_cipher_key' => nil do
      Repository::Subversion.create!(:password => 'foo', :url => 'file:///tmp')
      Repository::Subversion.create!(:password => 'bar', :url => 'file:///tmp')
    end
